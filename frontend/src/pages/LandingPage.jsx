        ...
        <div style={{ position: 'relative', overflowX: 'hidden', minHeight: '100vh' }}>
            ...
            <div className="container" style={{ paddingTop: '120px', paddingBottom: '100px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', marginTop: '5rem', gap: '2rem' }}>
                    ...
                    <Link to="/login" className="btn" style={{ padding: '1.2rem 4rem', fontSize: '1.1rem', background: 'rgba(255,255,255,0.05)', borderRadius: '50px', border: '1px solid rgba(255,255,255,0.1)', color: '#fff' }}>
                        Admin Portal
                    </Link>
                </div>
